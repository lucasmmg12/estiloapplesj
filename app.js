...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Inicializar nueva navegaci�n agrupada
...
function initGroupedNavigation() {
    ...
    navTabs.forEach(tab => {
        ...
        tab.addEventListener('click', () => {
            ...
            // Mostrar sub-navegación correspondiente
            ...
            // Si la categoría solo tiene un sub-item, activarlo automáticamente
    ...
    subNavItems.forEach(item => {
        ...
        item.addEventListener('click', () => {
            ...
            // Actualizar sub-item activo dentro de su categoría
...
// Llamar esta función después de DOMContentLoaded

// Agregar en app.js después de configurarEventListeners():
